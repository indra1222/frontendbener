        ...
        <>
          ...
          <div className="detail">
            <div className="panel furniture-panel">
              ...
              <div className="room-type-selector">
                ...
                <div className="room-type-buttons">
                  {roomTypes.map(room => (
                    <button
                      key={room.value}
                      className={`room-btn ${roomType === room.value ? 'active' : ''}`}
              ...
              <button 
                className="btn success btn-auto-all" 
                onClick={autoPlaceAllFurniture}
                disabled={loading}
                style={{
              ...
              >
                {loading ? (
                  <span style={{ color: '#ffffff' }}>Processing...</span>
                ) : (
                  <span style={{ color: '#ffffff' }}>🎯 Complete Auto Layout (All Furniture)</span>
                )}
              </button>
            </div>
